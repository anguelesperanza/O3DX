...
mkdir %ODINASM%
echo.
echo === Building Texture-Example (Citro3D Phase 6) ===
echo.
:: -------------------------------
...
:: (Texture-Example uses ctru_bridge and c3d_bridge — no c2d_bridge)
:: -------------------------------
echo.
...
:: -------------------------------
:: Link ELF  (no -lcitro2d — this example uses citro3d directly)
:: -------------------------------
echo.
echo Linking ELF...
