package drawellipsesolid_example
...
drawellipsesolid_main :: proc "c" (argc: i32, argv: [^]cstring) -> i32 {
	// Init
	ctru.gfxInitDefault()
	...
	for ctru.aptMainLoop() {
	    ...
	    c2d.C2D_DrawEllipseSolid(x = 10, y = 10, z = 0, w = 20, h = 40, clr = clrOrange) // -> bool ---
