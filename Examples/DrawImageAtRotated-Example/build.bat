...
if not exist %PNG_IMAGES% mkdir %PNG_IMAGES%
mkdir %ODINASM%
echo.
echo === Building DrawImageAtRotated-Example ===
echo.
:: -------------------------------
:: Copy sprite from Image-Example
:: (borrows image_64x64.png as the test sprite)
:: -------------------------------
echo Copying sprite from Image-Example...
copy /Y "..\Image-Example\png_images\image_64x64.png" "%PNG_IMAGES%\sprite.png" >nul
if errorlevel 1 (
    echo ERROR: Could not find ..\Image-Example\png_images\image_64x64.png
    echo Please ensure Image-Example exists in the repository.
    goto :fail
)
:: -------------------------------
