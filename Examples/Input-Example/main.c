// Input-Example: entry point + image-loading utility.
// All ABI bridge functions now live in lib/c2d/bridge.c and lib/c3d/bridge.c.
// This file provides:
//   main()          — calls the Odin entry point
//   load_t3x_image  — reads the custom .t3x format from romfs and uploads to GPU
